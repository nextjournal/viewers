         ...
         [:div.bg-white.shadow-md.rounded-md.overflow-hidden.border.border-gray-300.border-b-0
          [:ul.text-2xl
           (for [[route title] [[:devcards/root "Devcards"]
             ...
             ^{:key title}
             [:li
              [:a.text-gray-800.block.px-8.justify-between.py-4.text-xl.border-b.border-gray-300.flex.items-center.bg-white-50.hover:bg-gray-100.transition-all.ease-in-out.duration-150
               {:href (rfe/href route)}
               title
